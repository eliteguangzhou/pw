...
define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'By creating an account at Parfumwholesale you will be able to shop faster, be up to date on an orders status, and keep track of the orders you have previously made.');
