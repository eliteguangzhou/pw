...
<?php
    ...
    $prod_img = file_exists(DIR_WS_IMAGES . $random_product['products_image']) ? DIR_WS_IMAGES . $random_product['products_image'] : DIR_WS_IMAGES . '/no_img.gif';
    if (tep_not_null($random_product['specials_new_products_price'])) {
      ...
      $whats_new_price .= '<span class="productSpecialPrice">' . $currencies->display_price($random_product['specials_new_products_price'], tep_get_tax_rate($random_product['products_tax_class_id'])) . '</span>';
	   $pic_prod = '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '">' . tep_image($prod_img, $random_product['products_name'], HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT) . '</a>';
    } else {
