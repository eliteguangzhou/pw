...
$products_query = tep_db_query("SELECT DISTINCT manufacturers_name , manufacturers_id FROM manufacturers ORDER BY manufacturers_name");
...
//fin comptage des lignes
		...
		if ($i == 1) { 
					echo '<tr>'; 
							...
							echo '<td width="200"><a class="letter_center_roll" href="index.php?manufacturers_id='.$products['manufacturers_id'].'">'.$products['manufacturers_name'].'</a></td>';
