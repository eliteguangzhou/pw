...
// define the filenames used in the project
  ...
  define('FILENAME_CARD_GOLD','card_gold.php');
  define('FILENAME_CARD_SAPHIR','card_saphir.php');
  define('FILENAME_CARD_RUBIS','card_rubis.php');
  define('FILENAME_VIP','vip.php');
  define('FILENAME_CARDS','cards.php');
?>
