...
// build the message content
      ...
      if (ACCOUNT_GENDER == 'true') {
         if ($gender == 'm') {
           $text_gender = sprintf(EMAIL_GREET_MR, $lastname);
         } else {
           $text_gender = sprintf(EMAIL_GREET_MS, $lastname);
         }
      } else {
        $text_gender = sprintf(EMAIL_GREET_NONE, $firstname);
      }
	  
	  $email_text = EMAIL_WELCOME ;
      $email_text = str_replace( 'vpass', $password, $email_text);
      $email_text = str_replace( 'vlogin', $email_address, $email_text);
      $email_text = str_replace( 'vnom', $text_gender, $email_text);
