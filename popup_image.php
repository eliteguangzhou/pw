...
<body onload="resize();">
<?php
$prod_img = file_exists(DIR_WS_IMAGES . $products['products_image']) ? DIR_WS_IMAGES . $products['products_image'] : DIR_WS_IMAGES . '/no_img.gif';
echo '<img src="'.$prod_img.'" width="145" height="150" />';
