...
// lets start with the email confirmation
  $email_order = STORE_NAME . "\n" . 
                 EMAIL_SEPARATOR . "\n" .
                 (!$card_member->is_member() ? EMAIL_NOT_MEMBER . "\n" : sprintf(EMAIL_MEMBER, strtoupper($card_member->type), $card_member->expire)) . "\n" .
                 EMAIL_SEPARATOR . "\n" .
