...
?>
 ...
 ?></div><br><?php echo TEXT_SUCCESS; ?>
 <br>
 <!--<br>-->
<?php
  /*
	// On affiche le numéro de la commande venant de la session
	echo TEXT_ORDER_NUMBER .$insert_id.'<br><br>';
  // On affiche un message en fonction de la variable de session $higher500 
//if 	($higher500)? echo TEXT_SUCCESS_HIGH: echo TEXT_SUCCESS_LESS;
*/
	//echo TEXT_TITRE;

	// on affiche "$web_message" qui se trouve dans la session
	//echo  $web_message;
  /*
...
echo HEADING_TITLE;
?><br><br>
            <?php echo TEXT_THANKS_FOR_SHOPPING; ?></td>
          </tr>
        </table>
